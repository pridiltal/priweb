...
<span style="color:blue">**Anomaly Definition:**</span> Any behaviour which is unusual or unexpected **with respect to water quality considerations**
...
```{r timegapSandy, fig.cap= "Time gap between recorded time points of the sensors positioned at Sandy Creek." , out.width='70%', fig.height=3, fig.width=9}
```
...
```{r plot_score, warning=FALSE, message=FALSE, dependson='performance_plot'}
```
...
**Theorem**  (Weissman's Theorem). (Weissman (1978), Theorem 3) (Burridge and Taylor (2006),Proposition 1)
...
Reference: *Talagala, P. D., Hyndman, R., Leigh, C., Mengersen, K., Smith-Miles, K. (For review). A feature-based unsupervised approach for outlier detection in water quality data from in situ sensors. Water Resources Research.*