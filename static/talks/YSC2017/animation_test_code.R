...
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'line', trials = 300, window_skip = 50) }, 
        interval = 0.2)
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'out_location_plot', trials = 300, window_skip = 50) }, 
        interval = 0.2)
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'pcplot', trials = 300, window_skip = 50,  pc_boundary = 20) }, 
        interval = 0.2)

saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'mvtsplot', trials = 10, window_skip = 50) }, 
...
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'line', trials = 300, window_skip = 50) }, 
        interval = 0.2)
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'out_location_plot', trials = 300, window_skip = 50, concept_drift = TRUE) }, 
        interval = 0.2)
saveGIF({ find_odd_streams(train_data, test_stream , plot_type = 'pcplot', trials = 300, window_skip = 50,  pc_boundary = 20) }, 
        interval = 0.2)
