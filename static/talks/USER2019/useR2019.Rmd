...
- Can take the correlation structure of the water-quality variables into account when detecting outliers
--
...
Papers available from: [https://robjhyndman.com](https://robjhyndman.com/publications/) 
...
Slides created via xaringan: (https://github.com/pridiltal/MonashBS_xaringan)
