...
---
background-image:url('fig/thank.png')
background-position: 50% 50%
background-size: 100%
class: right, top
...
- One-class support vector machine (OCSVM) is a commonly
used method in anomaly detection research (Ma & Perkins 2003, Mahadevan &
Shah 2009, Rajasegarar et al. 2010).
- Raskutti & Kowalczyk (2004) and Zhuang & Dai (2006) have proposed improved versions of OCSVM for imbalanced data where the minority class (abnormal class) is specifically targeted in the classification.
- However **if minorities are difficult or expensive to obtained and defined
OCSVM for imbalanced data** is not among the best candidates for anomaly detection
due to unavailability of enough instances from the abnormal class to properly
train an OCSVM. 
- Further, Luca, Karsmakers & Vanrumste (2014) highlight some
limitations with OCSVM when more than one data point is observed that involves
