...
---
### Motivation
```{r motivation1, out.width = "100%", out.height="100%"}
knitr::include_graphics("fig/1_application.png")
```
---
...
Open problem : How do you incorporate the correlation across space within the dimension reduction to get a better 2D space?
...
- How do you decide what set of features is best for the problem?
...
Full paper available at: [https://robjhyndman.com/papers/oddstream.pdf](https://robjhyndman.com/papers/oddstream.pdf) <br/>

Slides available at: [https://prital.netlify.com/talk/acems2018-talk/](https://prital.netlify.com/talk/acems2018-talk/)  <br/><br/>
